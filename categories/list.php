<?php include __DIR__ . '/../conexion.php'; ?>
    ...
    <div class="banka-card">
        ...
        <h2>Categorías</h2>
        <a href="create.php" class="banka-btn banka-btn-success" style="margin-bottom: 20px;">+ Nueva Categoría</a>
...
foreach ($stmt as $row) {
    $typeBadge = $row['type'] == 'income' ? '<span class="banka-text-green">Ingreso</span>' : '<span class="banka-text-red">Gasto</span>';
    echo "<tr>
                        ...
                        <td data-label='Acciones'>
                            ...
                            <a href='delete.php?id={$row['id']}' class='banka-btn banka-btn-delete' onclick='return confirm(\"¿Deseas eliminar esta categoría?\");'>Eliminar</a>
                        </td>
                    </tr>";
}
?>
